...
export default function PlaceCard({ place, buildingName, onClose, onDirections }) {
  ...
  return (
    <div data-overlay="bottom" className="absolute inset-x-0 bottom-0 z-30 rounded-t-2xl bg-white p-4 shadow-map sm:inset-x-auto sm:bottom-6 sm:left-4 sm:w-[360px] sm:rounded-2xl">
